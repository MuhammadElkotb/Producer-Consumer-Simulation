...
public class Network {
    ...
    public static BufferQueue play(){
        ...
        Machine machine1 = new Machine("Machine 1", 500);
        Machine machine2 = new Machine("Machine 2", 2000);
        Machine machine3 = new Machine("Machine 3", 3000);
        Machine machine4 = new Machine("Machine 4", 600);
